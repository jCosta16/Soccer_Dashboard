    ...
    def league_data( soccer_data):
        ...
        for league in soccer_data["leagues"]:
            ...
            for result in results:
                ...
                name = Fix.accents(features[1].text)
                squad = int(features[3].text)
                foreigner = int(features[5].text)
                total_MV = float(Fix.value_us(features[6].text,curr_value))
                avg_MV = float(Fix.value_us(features[7].text,curr_value))
